...
/**
 * Get the angle between components of two 2D vectors. See {@link angleVec} for the angle between two
 * vectors.
 *
...
/**
 * Get the angle between two 2D vectors. See {@link angle} for the angle between components of two
 * vectors.
 *
 * @param   a The first operand
 * @param   b The second operand
...
/**
 * Returns whether or not the vectors exactly have the same elements in the same position (when
 * compared with ===)
 *
 ...
 * @param   stride       Number of elements between the start of each Vec2. Defaults to tightly
 *   packed (2).
